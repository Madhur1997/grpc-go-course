...
func (x *Operands) GetFirstNumber() int32 {
	if x != nil {
...
func (x *Operands) GetSecondNumber() int32 {
	if x != nil {
...
var file_calculatorpb_calculator_proto_rawDesc = []byte{
	...
	0x0a, 0x63, 0x61, 0x6c, 0x63, 0x75, 0x6c, 0x61, 0x74, 0x6f, 0x72, 0x22, 0x52, 0x0a, 0x08, 0x4f,
	0x70, 0x65, 0x72, 0x61, 0x6e, 0x64, 0x73, 0x12, 0x21, 0x0a, 0x0c, 0x66, 0x69, 0x72, 0x73, 0x74,
	...
	,
...
var file_calculatorpb_calculator_proto_depIdxs = []int32{
	...
	2, // 2: calculator.Calculator.Max:input_type -> calculator.ReqNum
	1, // 3: calculator.Calculator.Add:output_type -> calculator.Result
	1, // 4: calculator.Calculator.Avg:output_type -> calculator.Result
	1, // 5: calculator.Calculator.Max:output_type -> calculator.Result
...
func (c *calculatorClient) Add(ctx context.Context, in *Operands, opts ...grpc.CallOption) (*Result, error) {
	out := new(Result)
...
func (c *calculatorClient) Max(ctx context.Context, opts ...grpc.CallOption) (Calculator_MaxClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Calculator_serviceDesc.Streams[1], "/calculator.Calculator/Max", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *calculatorMaxClient) Send(m *ReqNum) error {
	return x.ClientStream.SendMsg(m)
}

func (x *calculatorMaxClient) Recv() (*Result, error) {
	m := new(Result)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (x *calculatorMaxServer) Send(m *Result) error {
	return x.ServerStream.SendMsg(m)
}

func (x *calculatorMaxServer) Recv() (*ReqNum, error) {
	m := new(ReqNum)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
